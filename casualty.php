...
<body bgcolor="#EDEDED">
<ol start="1"></br>
<h3><span style="background-color: #B5B5B5;"><b>各國內戰</b></span> </h3>
<p>統計kaggle每年對各國內戰之分類與死亡人數，</p>
...
$sql= "SELECT * FROM casualty_range";
...
if ($result=mysqli_query($link,$sql)) {
 ...
 echo "</table><br>";
 if ( $page > 1 )
  echo "<a href='casualty.php?page=".($page-1).
           "'>上一頁</a>| ";
 for ( $i = 1; $i <= $total_pages; $i++ )
  if ($i != $page)
   echo "<a href=\"casualty.php?page=".$i."\">".
           $i."</a> ";
  else
   echo $i." ";
...
<hr>
<h3>資料來源:</h3>
<a href="https://worldpopulationreview.com/country-rankings/countries-currently-at-war">Countries Currently At War 2022</a>
</body>
</html>
