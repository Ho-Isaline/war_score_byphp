...
<body bgcolor="#EDEDED">
<ol start="1"></br>
<h3><span style="background-color: #B5B5B5;"><b>軍事排名</b></span> </h3>
<p>統計各國最新2022軍事排名與分數，</p>
...
if ($result=mysqli_query($link,$sql)) {
 ...
 echo "</table><br>";
 if ( $page > 1 )
  echo "<a href='military.php?page=".($page-1).
           "'>上一頁</a>| ";
 for ( $i = 1; $i <= $total_pages; $i++ )
  if ($i != $page)
   echo "<a href=\"military.php?page=".$i."\">".
           $i."</a> ";
  else
   echo $i." ";
...
<hr>
<h3>資料來源:</h3>
<a href="https://www.globalfirepower.com/countries-listing.php">2022 Military Strength Ranking</a>
</body>
</html>
